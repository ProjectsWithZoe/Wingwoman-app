import React from "react"; const PrivacyPolicy = () => { return (
<div>
  ...
  <div>
    ...
    <ul>
      ...
      <li>
        ...
        website, including IP address, browser type, and device information.
      </li>
      <li>
        <strong>Cookies and Tracking Technologies:</strong> We use cookies to
        enhance user experience and analyze site performance.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <strong>Legal Authorities:</strong> When required to comply with legal
